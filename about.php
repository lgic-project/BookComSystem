...
<body>
    ...
    <p>
        At <strong>Bookly</strong>, we bring the world of stories, knowledge, and inspiration right to your doorstep. We are committed to offering readers a vast and diverse collection of books at affordable prices, catering to every interest and age group. Whether you're into <em>Fiction, Non-fiction, Science, History, or Self-Help</em>, we have something for every kind of reader.
    </p>
    ...
    <div class="features">
        <div class="feature">
            📖 <strong>Vast Collection</strong>: A wide variety of books across genres like Fiction, Non-fiction, Science, History, Self-help, and Educational materials.
        </div>
        <div class="feature">
            💰 <strong>Affordable Prices</strong>: Get great books at unbeatable prices without compromising on quality.
        </div>
        <div class="feature">
            🚀 <strong>Fast Delivery</strong>: Ensuring a quick and hassle-free delivery experience across Nepal.
        </div>
        <div class="feature">
            🌐 <strong>Easy Navigation</strong>: A smooth and intuitive interface for hassle-free browsing and searching.
        </div>
        <div class="feature">
            💖 <strong>Local Talent Support</strong>: Promoting books from Nepalese authors and giving a platform to our local literary community.
        </div>
    </div>
</div>
        ...
        <section class="about-dev">
            ...
            <div class="developers">
                ...
                <div class="profile-card">
                    ...
                    <div class="media-buttons">
                        <a href="https://www.facebook.com/roshan.adhikari.31149" target="_blank" style="background: #4267b2" class="link"> <i class="fas fa-facebook"></i> </a>
                        <a href="https://www.instagram.com/name.is.sabeen/" target="_blank" style="background: #e1306c" class="link"> <i class="fas fa-instagram"></i> </a>
                    </div>
                </div>
